...
class student:
    def __init__(self,root):
        ...
        #1st
        img=Image.open(r"college_images\VIT1.jpg")
       ...
       #2nd
        img_2=Image.open(r"college_images\logo-vit-1.png")
        img_2=img_2.resize((400,110),Image.ANTIALIAS)
        ...
        #3rd
        img_3=Image.open(r"college_images\VIT7.jpg")
        ...
        lbl_title=Label(bg_lbl,text="COLLEGE MANAGEMENT SYSTEM",font=("times new roman",37,"bold"),fg="blue",bg="white")
        ...
        #left frame
        DataLeftFrame=LabelFrame(Manage_frame,bd=4,relief=RIDGE,padx=2,text="College Information",font=("times new roman",12,"bold"),fg="blue",bg="white")
        DataLeftFrame.place(x=10,y=10,width=660,height=540)

        #img
        img_5=Image.open(r"college_images\VIT2.jpeg")
        ...
        #Department
        course_std=Label(std_lbl_info_frame,font=("arial",12,"bold"),text="Department",bg="white")
        ...
        com_txtcourse_std["value"]=("Select Courses","FY","SY","TY","LY")
        ...
        com_txtcourse_year=ttk.Combobox(std_lbl_info_frame,textvariable=self.var_year,state="readonly",
                                                        font=("arial",12,"bold"),width=17)
        ...
        #img1
        img_6=Image.open(r"college_images\VIT3.jpg")
    ...
    def add_data(self):
        if (self.var_dep.get()=="" or self.var_email.get()=="" or self.var_std_id.get()==""):
            ...
            try:
                conn=mysql.connector.connect(host="Localhost",username ="root",password="tejas@mysql123",database="mydata")
